...
class AIPlayer:
    ...
    def eval2(self, board):
        score = 0.1*self.score_position(board, self.player_number) - self.score_position(board, 2 if self.player_number == 1 else 1)
        return score
